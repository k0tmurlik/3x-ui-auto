[English](/README.md)
<p align="center"><a href="#"><img src="https://github.com/k0tmurlik/3x-ui-auto/raw/test/media/3X-UI.png" alt="Image"></a></p>
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/k0tmurlik/3x-ui-auto/refs/heads/main/xui-rp-install.sh)
```
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/k0tmurlik/3x-ui-auto/refs/heads/main/xui-rp-install.sh) -bot
```

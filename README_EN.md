...
<p align="center"><a href="#"><img src="https://github.com/k0tmurlik/3x-ui-auto/blob/test/media/3X-UI.png?raw=true" alt="Image"></a></p>
...
```sh
bash <(curl -Ls https://github.com/k0tmurlik/3x-ui-auto/raw/refs/heads/test/xui-rp-install-server.sh)
```
...
```sh
bash <(https://github.com/k0tmurlik/3x-ui-auto/raw/refs/heads/test/xui-rp-install-server.sh) -bot
```
